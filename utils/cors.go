...
func CORSMiddleware() func(c *gin.Context) {
	...
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Accept, Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, X-Requested-With, origin")
